...
import { FiUser, FiBook, FiLogOut, FiCalendar } from "react-icons/fi";
...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <NavLink to="/student-dashboard" className="flex items-center justify-center p-1">
        <img
      ...
      <nav className="mt-5 flex flex-col space-y-4">
        ...
        <NavItem to="/rules-and-regulations" icon={<FiBook />} label="Rules" isExpanded={isExpanded} />
        <NavItem to="/reservation/calendar" icon={<FiCalendar />} label="Reservation" isExpanded={isExpanded} />
      </nav>
